    ...
    <form className="flex flex-col items-center sm:h-40">
      <div className="bg-none border border-green-gold w-full sm:h-3/4 p-6 pb-6 shadow-2xl rounded sm:border-hidden sm:p-0 sm:pb-2">
        ...
        <textarea
          ...
          required={true}
        />
        <button className="inline-block mt-2 bg-green-gold hover:bg-white hover:text-green-gold hover:border-green-gold font-body px-6 py-2 rounded text-white shadow-lg">
          SEND
        </button>
      </div>
    </form>
